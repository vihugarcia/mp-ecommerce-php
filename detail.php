...
$preference->back_urls = array(
    "success" => $protocol . $_SERVER['SERVER_NAME'] . "/process-payment.php?status=success",
    "failure" => $protocol . $_SERVER['SERVER_NAME'] . "/process-payment.php?status=failure",
    "pending" => $protocol . $_SERVER['SERVER_NAME'] . "/process-payment.php?status=pending"    
);
